...
function getIdLoc(id) {
	var elem = document.getElementById(id);
	var posY = parseInt(elem.style.top);
	var posX = parseInt(elem.style.left);
	document.getElementById("testArea").innerHTML += "elem " + id + " posX: " + posX + " posY: " + posY + "<br>";
}
...
function initGridPoints(numRows, numCols, uRight, lLeft) {
	...
	var dx = (uRight.x - lLeft.x) / (numCols - 1);
	var dy = (uRight.y - lLeft.y) / (numRows - 1);
